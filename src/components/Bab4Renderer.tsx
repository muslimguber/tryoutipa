...
export const Bab4Renderer = ({ theme, username, userClass, title, onComplete }: any) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start py-8 px-4">
      {/* Tabs Menu */}
      <div className="w-full max-w-4xl mb-6 bg-blue-900/80 p-1 sm:p-1.5 rounded-xl sm:rounded-2xl flex items-stretch justify-between gap-1 shadow-lg backdrop-blur-md border border-white/10 overflow-hidden">
        {TABS.map((tab, idx) => {
